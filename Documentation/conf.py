...
htmlhelp_basename = 'DevHero.News'
...
latex_documents = [
  (master_doc, 'DevHero.News.tex', u'DevHero.News Documentation',
   u'The author', 'manual'),
]
...
man_pages = [
    (master_doc, 'DevHero.News', u'DevHero.News Documentation',
     [author], 1)
]
